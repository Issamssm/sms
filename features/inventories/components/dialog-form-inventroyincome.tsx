...
type InventoryIncomeFormValue = z.infer<typeof createInventoryIncomeFormSchema>
...
export const DialogFormInventoryIncome = ({
    ...
    const form = useForm<z.infer<typeof createInventoryIncomeFormSchema>>({
        resolver: zodResolver(createInventoryIncomeFormSchema),
        defaultValues: {
            quantity: 0,
            costPrice: 0,
            location: "",
